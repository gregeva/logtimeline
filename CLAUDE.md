...
- 2026-08-23: RELEASE-NOTE BULLETS reflect the change concisely — not every detail of it, and never pre-existing general behaviour (#396 bullet described stack-trace handling). Rule in per-feature step 6.
