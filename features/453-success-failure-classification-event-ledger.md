...
- Phase: S2 schema + decide complete 2026-08-28 (§ *12*); next stage S3 (counting at the include point, per-message slots, consolidation merge, the `classification` sub-section and its harness scenarios) on instruction
