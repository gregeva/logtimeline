...
### Consolidation (2026-08-20) — PROPOSED decisions D26–D34 from the prototype phase (pending architect lock)

Each distills the referenced P-finding into the design the implementation follows. Numbering continues the umbrella sequence after D25.
