...
### Phases (trued up 2026-07-15 — 0.17.0 merge train)
...
| #57 | — | 2a | Bucket data structure prototype (go/no-go gate for Drop 2) | #58 (design context) | **In** |
| #59 | 2 | 2 | Sliding-window deferred-per-bucket processing | #58, #57 | **In** |
| #60 | 3 | 3 | Configurable metric visibility and purpose | #59 | **In** |
| #61 | 4 | — | Derived metrics (intra-line and inter-line) | #60, #55 (#54 already COMPLETE) | **Out — deferred to a later release (D16)** |
